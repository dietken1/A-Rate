    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/auth/**", "/google-auth/**", "/api/auth/test", "/api/auth/simple-test", "/api/auth/test-token", "/api/auth/dev-token", "/api/auth/refresh", "/api/auth/me", "/login/oauth2/code/**").permitAll()
